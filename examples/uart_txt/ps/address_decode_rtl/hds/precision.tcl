...
if {[string length [info commands new_project]]} {
   new_project -name address_decode_rtl -folder "C:/d_drive/Builds/HDS/hds_aeshak_GIT_HDS_Main_hint_2020.2_4316671_hint/examples/UART_TXT/ps/address_decode_rtl"
} else {
   set_working_dir "C:/d_drive/Builds/HDS/hds_aeshak_GIT_HDS_Main_hint_2020.2_4316671_hint/examples/UART_TXT/ps/address_decode_rtl"
}
...
catch {source "C:/d_drive/Builds/HDS/hds_aeshak_GIT_HDS_Main_hint_2020.2_4316671_hint/examples/UART_TXT/ps/address_decode_rtl/hds/add_files.tcl"}
